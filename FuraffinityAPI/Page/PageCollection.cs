...
namespace FuraffinityAPI.Page
{
    public class PageCollection<T> : IDisposable
    {
        ...
        internal PageCollection(HttpClient httpClient, SemaphoreSlim semaphore, string userName)
        {
            _lock = new object();
        ...
        internal void NewGalleryTask(HttpClient httpClient, SemaphoreSlim semaphore, string userName)
        {
        ...
        internal void NewFavoritesTask(HttpClient httpClient, SemaphoreSlim semaphore, string userName)
        {
        ...
        internal void NewStarTask(HttpClient httpClient, SemaphoreSlim semaphore, string userName)
        {
        ...
        internal void NewFansTask(HttpClient httpClient, SemaphoreSlim semaphore, string userName)
        {
